...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2025 a las 19:31:46
...
(2, 1, 50, 1, 786, 'Matutino', 3, 3, 0, 0, '', 'activo', '2025-11-21 17:41:35', '2025-11-21 17:41:35', 1),
...
CREATE TABLE `carga_plantillas` (
  ...
  `datos_json` longtext NOT NULL COMMENT 'Datos de la plantilla en formato JSON',
  `estado` enum('activo','eliminado') NOT NULL DEFAULT 'activo',
  `fecha_creacion` timestamp NOT NULL DEFAULT current_timestamp(),
  `fecha_modificacion` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
