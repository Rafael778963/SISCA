...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2025 a las 09:45:56
...
(7, 1, '52MERC6M', '52', 'TSU', 'MERC', '6', NULL, 'M', '2025-11-28 07:46:05', '2025-11-28 07:46:05', 'activo'),
(8, 1, '52MI6N', '52', 'TSU', 'MI', '6', NULL, 'N', '2025-11-28 07:46:20', '2025-11-28 07:46:20', 'activo'),
(12, 1, '52INGE7M', '52', 'I', 'INGE', '7', NULL, 'M', '2025-11-28 07:46:54', '2025-11-28 07:50:16', 'activo');
...
--
-- Estructura de tabla para la tabla `plan_estudios_asignaturas`
--

CREATE TABLE `plan_estudios_asignaturas` (
  `id` int(11) NOT NULL,
  `periodo_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `plan_estudios_asignaturas`
--

INSERT INTO `plan_estudios_asignaturas` (`id`, `periodo_id`, `nivel`, `turno`, `programa_educativo`, `cuatrimestre`, `area_conocimiento`, `asignatura`, `horas_total`, `estado`, `fecha_creacion`, `fecha_modificacion`) VALUES
(1, 1, 'Ing', 'Matutino', 'dfg', 1, 'ss', 'asd', 2, 'inactivo', '2025-11-28 08:34:41', '2025-11-28 08:35:01'),
(2, 1, 'Ing', 'Matutino', 'DATOS 1', 6, 'Areas', 'Matematicas', 20, 'activo', '2025-11-28 08:36:30', '2025-11-28 08:36:30'),
(3, 1, 'TSU', 'Nocturno', 'Areas', 4, 'aaaaaaaa', 'aaaaa', 23, 'activo', '2025-11-28 08:37:16', '2025-11-28 08:37:16');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `plan_estudios_plantillas`
--

CREATE TABLE `plan_estudios_plantillas` (
  `id` int(11) NOT NULL,
  `nombre_plantilla` varchar(100) NOT NULL,
  `descripcion` varchar(255) DEFAULT NULL,
  `periodo_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `plan_estudios_plantillas`
--

INSERT INTO `plan_estudios_plantillas` (`id`, `nombre_plantilla`, `descripcion`, `periodo_id`, `usuario_id`, `datos_json`, `estado`, `fecha_creacion`, `fecha_modificacion`) VALUES
(1, 'Plantilla 2025-Prueba-2', 'fgdfgdsfg', 1, 1, '{\"asignaturas\":[{\"id\":2,\"periodo_id\":1,\"nivel\":\"Ing\",\"turno\":\"Matutino\",\"programa_educativo\":\"DATOS 1\",\"cuatrimestre\":6,\"area_conocimiento\":\"Areas\",\"asignatura\":\"Matematicas\",\"horas_total\":20,\"estado\":\"activo\",\"fecha_creacion\":\"2025-11-28 02:36:30\",\"fecha_modificacion\":\"2025-11-28 02:36:30\"}],\"fecha_guardado\":\"2025-11-28T08:36:37.540Z\",\"total_registros\":1}', 'activo', '2025-11-28 08:36:37', '2025-11-28 08:36:37');
...
--
-- Indices de la tabla `plan_estudios_asignaturas`
--
ALTER TABLE `plan_estudios_asignaturas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_periodo` (`periodo_id`),
  ADD KEY `idx_nivel_turno` (`nivel`,`turno`),
  ADD KEY `idx_programa` (`programa_educativo`),
  ADD KEY `idx_estado` (`estado`);

--
-- Indices de la tabla `plan_estudios_plantillas`
--
...
--
-- AUTO_INCREMENT de la tabla `plan_estudios_asignaturas`
--
ALTER TABLE `plan_estudios_asignaturas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `plan_estudios_plantillas`
--
ALTER TABLE `plan_estudios_plantillas`
