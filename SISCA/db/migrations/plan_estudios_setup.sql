-- ====================================
-- MIGRACIÓN: PLAN DE ESTUDIOS
-- ====================================
-- Este script crea las tablas necesarias para el módulo de Plan de Estudios
-- Ejecutar este script en la base de datos SISCA

USE sisca;

-- ====================================
-- 1. Tabla: plan_estudios_asignaturas
-- ====================================
-- Almacena las asignaturas del plan de estudios por periodo académico
...
-- ====================================
-- 2. Tabla: plan_estudios_plantillas
-- ====================================
-- Almacena plantillas guardadas de planes de estudio
...
-- ====================================
-- 3. Restricciones de clave foránea (opcional)
-- ====================================
-- Descomentar si las tablas periodos y usuarios existen
...
SELECT 'Migración de Plan de Estudios completada exitosamente' AS mensaje;
